...
@StandardFunctionType(
        type = FunctionEnumType.MEASUREMENT_SERIES_LIST_DATA,
        featureType = FeatureTypeEnumType.MEASUREMENT)
public class MeasurementSeriesListDataFunction extends MeasurementFeatureFunction<
    ...
    public static final ListFeatureFunctionTypeInfo<
        ...
        new DataIdDescription<>(
            MeasurementSeriesDataType.class,
            List.of("measurementId", "timestamp")
        ),
        MeasurementSeriesListDataType.class,
        MeasurementSeriesListDataSelectorsType.class,
        MeasurementSeriesDataElementsType.class
    );

    public MeasurementSeriesListDataFunction() {
        super(FunctionEnumType.MEASUREMENT_SERIES_LIST_DATA.value(), TYPE_INFO);
        setReadable(true, true);
    }

    @Override
    protected void validateReadCmd(
        List<MeasurementSeriesListDataSelectorsType> measurementSeriesListDataSelectorsTypes,
        MeasurementSeriesDataElementsType elements,
    ...
    @Override
    protected void validateData(MeasurementSeriesDataType data) throws
        ...
        if (vType != null && !isValidEnumValue(
            ...
            throw new DataValidationException("valueType "
                + vType
                + " is not a valid type");
        }
        ...
        if (data.getValue() == null && data.getValueState() == null || !data
            .getValueState()
            .equals(
     ...
     */
    public boolean checkAndSetDataOutOfRange(MeasurementSeriesDataType data) {
    ...
    private boolean isDataOutOfRange(MeasurementSeriesDataType data) {
        ...
        if (value != null && (Objects.equals(valueType, valueValueType)
            || Objects.equals(valueType, averageValueValueType)
        )) {
    ...
    protected void validateRecommendedBehaviour(MeasurementSeriesDataType data) throws
        DataValidationException {
