...
/**
 * <p>Java class for ThresholdDescriptionDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ThresholdDescriptionDataType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="thresholdId" type="{http://docs.eebus.org/spine/xsd/v1}ThresholdIdType" minOccurs="0"/&gt;
 *         &lt;element name="thresholdType" type="{http://docs.eebus.org/spine/xsd/v1}ThresholdTypeType" minOccurs="0"/&gt;
...
@XmlType(name = "ThresholdDescriptionDataType", propOrder = {
    "thresholdId",
    "thresholdType",
    "unit",
    "scopeType",
...
public class ThresholdDescriptionDataType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public ThresholdDescriptionDataType() {
        super();
    }
     ...
     * 
     */
    public ThresholdDescriptionDataType(final Long thresholdId, final String thresholdType, final String unit, final String scopeType, final String label, final String description) {
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataType withThresholdId(Long value) {
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataType withThresholdType(String value) {
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataType withUnit(String value) {
        setUnit(value);
        return this;
    }
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataType withScopeType(String value) {
        setScopeType(value);
        return this;
    }
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataType withLabel(String value) {
        setLabel(value);
        return this;
    }
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataType withDescription(String value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ThresholdDescriptionDataType) {
            final ThresholdDescriptionDataType copy = ((ThresholdDescriptionDataType) draftCopy);
            {
            ...
            }
            {
                ...
                if (thresholdTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceThresholdType;
                    sourceThresholdType = this.getThresholdType();
                    String copyThresholdType = ((String) strategy.copy(LocatorUtils.property(locator, "thresholdType", sourceThresholdType), sourceThresholdType, (this.thresholdType!= null)));
    ...
    public boolean equals(Object object) {
        ...
        final ThresholdDescriptionDataType that = ((ThresholdDescriptionDataType) object);
        {
        ...
        {
            String leftThresholdType;
            leftThresholdType = this.getThresholdType();
            String rightThresholdType;
