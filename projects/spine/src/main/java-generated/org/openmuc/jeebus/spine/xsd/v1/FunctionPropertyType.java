...
/**
 * <p>Java class for FunctionPropertyType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="function" type="{http://docs.eebus.org/spine/xsd/v1}FunctionType" minOccurs="0"/&gt;
 *         &lt;element name="possibleOperations" type="{http://docs.eebus.org/spine/xsd/v1}PossibleOperationsType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "FunctionPropertyType", propOrder = {
    "function",
    "possibleOperations"
})
public class FunctionPropertyType implements Cloneable, CopyTo, ToString
{

    protected String function;
    protected PossibleOperationsType possibleOperations;

    /**
     * Default no-arg constructor
     * 
     */
    public FunctionPropertyType() {
        super();
    }
     ...
     * 
     */
    public FunctionPropertyType(final String function, final PossibleOperationsType possibleOperations) {
     ...
     * @return
     *     possible object is
     *     {@link PossibleOperationsType }
     *     
     */
    public PossibleOperationsType getPossibleOperations() {
     ...
     *     
     */
    public void setPossibleOperations(PossibleOperationsType value) {
     ...
     *     The class instance
     */
    public FunctionPropertyType withFunction(String value) {
        setFunction(value);
        return this;
    }
     ...
     *     The class instance
     */
    public FunctionPropertyType withPossibleOperations(PossibleOperationsType value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof FunctionPropertyType) {
            final FunctionPropertyType copy = ((FunctionPropertyType) draftCopy);
            {
            ...
            }
            {
                ...
                if (possibleOperationsShouldBeCopiedAndSet == Boolean.TRUE) {
                    PossibleOperationsType sourcePossibleOperations;
                    sourcePossibleOperations = this.getPossibleOperations();
                    PossibleOperationsType copyPossibleOperations = ((PossibleOperationsType) strategy.copy(LocatorUtils.property(locator, "possibleOperations", sourcePossibleOperations), sourcePossibleOperations, (this.possibleOperations!= null)));
    ...
    public boolean equals(Object object) {
        ...
        final FunctionPropertyType that = ((FunctionPropertyType) object);
        {
            String leftFunction;
        ...
        {
            PossibleOperationsType leftPossibleOperations;
            leftPossibleOperations = this.getPossibleOperations();
            PossibleOperationsType rightPossibleOperations;
    ...
    public int hashCode() {
        ...
        {
            currentHashCode = (currentHashCode* 31);
            PossibleOperationsType thePossibleOperations;
