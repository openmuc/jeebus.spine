...
/**
 * <p>Java class for TierDescriptionDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TierDescriptionDataType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "TierDescriptionDataType", propOrder = {
    "tierId",
    "tierType",
    "label",
    "description"
...
@XmlSeeAlso({
    org.openmuc.jeebus.spine.xsd.v1.IncentiveTableDescriptionTierType.TierDescription.class
})
public class TierDescriptionDataType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public TierDescriptionDataType() {
        super();
    }
     ...
     * 
     */
    public TierDescriptionDataType(final Long tierId, final String tierType, final String label, final String description) {
        this.tierId = tierId;
     ...
     *     The class instance
     */
    public TierDescriptionDataType withTierId(Long value) {
        setTierId(value);
        return this;
    }
     ...
     *     The class instance
     */
    public TierDescriptionDataType withTierType(String value) {
        setTierType(value);
        return this;
    }
     ...
     *     The class instance
     */
    public TierDescriptionDataType withLabel(String value) {
        setLabel(value);
        return this;
    }
     ...
     *     The class instance
     */
    public TierDescriptionDataType withDescription(String value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TierDescriptionDataType) {
            final TierDescriptionDataType copy = ((TierDescriptionDataType) draftCopy);
            {
    ...
    public boolean equals(Object object) {
        ...
        final TierDescriptionDataType that = ((TierDescriptionDataType) object);
        {
            Long leftTierId;
