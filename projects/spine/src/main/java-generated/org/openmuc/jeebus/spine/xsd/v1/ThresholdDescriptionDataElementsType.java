...
/**
 * <p>Java class for ThresholdDescriptionDataElementsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ThresholdDescriptionDataElementsType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="thresholdId" type="{http://docs.eebus.org/spine/xsd/v1}ElementTagType" minOccurs="0"/&gt;
 *         &lt;element name="thresholdType" type="{http://docs.eebus.org/spine/xsd/v1}ElementTagType" minOccurs="0"/&gt;
...
@XmlType(name = "ThresholdDescriptionDataElementsType", propOrder = {
    "thresholdId",
    "thresholdType",
    "unit",
    "scopeType",
...
public class ThresholdDescriptionDataElementsType implements Cloneable, CopyTo, ToString
{

    protected ElementTagType thresholdId;
    protected ElementTagType thresholdType;
     ...
     * 
     */
    public ThresholdDescriptionDataElementsType() {
        super();
    }
     ...
     * 
     */
    public ThresholdDescriptionDataElementsType(final ElementTagType thresholdId, final ElementTagType thresholdType, final ElementTagType unit, final ElementTagType scopeType, final ElementTagType label, final ElementTagType description) {
     ...
     *     
     */
    public ElementTagType getThresholdType() {
     ...
     *     
     */
    public void setThresholdType(ElementTagType value) {
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataElementsType withThresholdId(ElementTagType value) {
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataElementsType withThresholdType(ElementTagType value) {
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataElementsType withUnit(ElementTagType value) {
        setUnit(value);
        return this;
    }
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataElementsType withScopeType(ElementTagType value) {
        setScopeType(value);
        return this;
    }
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataElementsType withLabel(ElementTagType value) {
        setLabel(value);
        return this;
    }
     ...
     *     The class instance
     */
    public ThresholdDescriptionDataElementsType withDescription(ElementTagType value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ThresholdDescriptionDataElementsType) {
            final ThresholdDescriptionDataElementsType copy = ((ThresholdDescriptionDataElementsType) draftCopy);
            {
            ...
            {
                Boolean thresholdTypeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.thresholdType!= null));
                if (thresholdTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    ElementTagType sourceThresholdType;
                    sourceThresholdType = this.getThresholdType();
                    ElementTagType copyThresholdType = ((ElementTagType) strategy.copy(LocatorUtils.property(locator, "thresholdType", sourceThresholdType), sourceThresholdType, (this.thresholdType!= null)));
                    copy.setThresholdType(copyThresholdType);
                } else {
                    if (thresholdTypeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.thresholdType = null;
                    }
                }
            }
            {
    ...
    public boolean equals(Object object) {
        ...
        final ThresholdDescriptionDataElementsType that = ((ThresholdDescriptionDataElementsType) object);
        {
        ...
        {
            ElementTagType leftThresholdType;
            leftThresholdType = this.getThresholdType();
            ElementTagType rightThresholdType;
            rightThresholdType = that.getThresholdType();
            if (this.thresholdType!= null) {
                if (that.thresholdType!= null) {
                    if (!leftThresholdType.equals(rightThresholdType)) {
                        return false;
                    }
                } else {
                    return false;
    ...
    public int hashCode() {
        ...
        {
            currentHashCode = (currentHashCode* 31);
            ElementTagType theThresholdType;
            theThresholdType = this.getThresholdType();
            if (this.thresholdType!= null) {
                currentHashCode += theThresholdType.hashCode();
            }
        }
        {
            currentHashCode = (currentHashCode* 31);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ElementTagType theThresholdType;
            theThresholdType = this.getThresholdType();
            strategy.appendField(locator, this, "thresholdType", buffer, theThresholdType, (this.thresholdType!= null));
        }
        {
            ElementTagType theUnit;
            theUnit = this.getUnit();
