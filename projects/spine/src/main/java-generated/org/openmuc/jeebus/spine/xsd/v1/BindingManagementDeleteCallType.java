...
/**
 * <p>Java class for BindingManagementDeleteCallType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BindingManagementDeleteCallType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BindingManagementDeleteCallType", propOrder = {
    "bindingId",
    "clientAddress",
    "serverAddress"
})
@XmlSeeAlso({
    org.openmuc.jeebus.spine.xsd.v1.NodeManagementBindingDeleteCallType.BindingDelete.class
})
public class BindingManagementDeleteCallType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public BindingManagementDeleteCallType() {
        super();
    }
     ...
     * 
     */
    public BindingManagementDeleteCallType(final Long bindingId, final FeatureAddressType clientAddress, final FeatureAddressType serverAddress) {
     ...
     *     The class instance
     */
    public BindingManagementDeleteCallType withBindingId(Long value) {
        setBindingId(value);
        return this;
    }
     ...
     *     The class instance
     */
    public BindingManagementDeleteCallType withClientAddress(FeatureAddressType value) {
     ...
     *     The class instance
     */
    public BindingManagementDeleteCallType withServerAddress(FeatureAddressType value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BindingManagementDeleteCallType) {
            final BindingManagementDeleteCallType copy = ((BindingManagementDeleteCallType) draftCopy);
            {
    ...
    public boolean equals(Object object) {
        ...
        final BindingManagementDeleteCallType that = ((BindingManagementDeleteCallType) object);
        {
            Long leftBindingId;
