...
/**
 * <p>Java class for SensingDescriptionDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SensingDescriptionDataType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="sensingType" type="{http://docs.eebus.org/spine/xsd/v1}SensingTypeType" minOccurs="0"/&gt;
...
@XmlType(name = "SensingDescriptionDataType", propOrder = {
    "sensingType",
    "unit",
    "scopeType",
    "label",
...
public class SensingDescriptionDataType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public SensingDescriptionDataType() {
        super();
    }
     ...
     * 
     */
    public SensingDescriptionDataType(final String sensingType, final String unit, final String scopeType, final String label, final String description) {
     ...
     *     
     */
    public void setSensingType(String value) {
     ...
     *     The class instance
     */
    public SensingDescriptionDataType withSensingType(String value) {
     ...
     *     The class instance
     */
    public SensingDescriptionDataType withUnit(String value) {
        setUnit(value);
        return this;
    }
     ...
     *     The class instance
     */
    public SensingDescriptionDataType withScopeType(String value) {
        setScopeType(value);
        return this;
    }
     ...
     *     The class instance
     */
    public SensingDescriptionDataType withLabel(String value) {
        setLabel(value);
        return this;
    }
     ...
     *     The class instance
     */
    public SensingDescriptionDataType withDescription(String value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SensingDescriptionDataType) {
            final SensingDescriptionDataType copy = ((SensingDescriptionDataType) draftCopy);
            {
                ...
                if (sensingTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceSensingType;
                    sourceSensingType = this.getSensingType();
                    String copySensingType = ((String) strategy.copy(LocatorUtils.property(locator, "sensingType", sourceSensingType), sourceSensingType, (this.sensingType!= null)));
    ...
    public boolean equals(Object object) {
        ...
        final SensingDescriptionDataType that = ((SensingDescriptionDataType) object);
        {
            String leftSensingType;
            leftSensingType = this.getSensingType();
            String rightSensingType;
