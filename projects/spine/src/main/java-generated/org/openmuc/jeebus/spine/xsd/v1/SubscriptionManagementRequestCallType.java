...
/**
 * <p>Java class for SubscriptionManagementRequestCallType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SubscriptionManagementRequestCallType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SubscriptionManagementRequestCallType", propOrder = {
    "clientAddress",
    "serverAddress",
    "serverFeatureType"
})
@XmlSeeAlso({
    org.openmuc.jeebus.spine.xsd.v1.NodeManagementSubscriptionRequestCallType.SubscriptionRequest.class
})
public class SubscriptionManagementRequestCallType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public SubscriptionManagementRequestCallType() {
        super();
    }
     ...
     * 
     */
    public SubscriptionManagementRequestCallType(final FeatureAddressType clientAddress, final FeatureAddressType serverAddress, final String serverFeatureType) {
     ...
     *     The class instance
     */
    public SubscriptionManagementRequestCallType withClientAddress(FeatureAddressType value) {
     ...
     *     The class instance
     */
    public SubscriptionManagementRequestCallType withServerAddress(FeatureAddressType value) {
     ...
     *     The class instance
     */
    public SubscriptionManagementRequestCallType withServerFeatureType(String value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SubscriptionManagementRequestCallType) {
            final SubscriptionManagementRequestCallType copy = ((SubscriptionManagementRequestCallType) draftCopy);
            {
    ...
    public boolean equals(Object object) {
        ...
        final SubscriptionManagementRequestCallType that = ((SubscriptionManagementRequestCallType) object);
        {
