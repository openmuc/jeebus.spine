...
/**
 * <p>Java class for SubscriptionManagementRequestCallElementsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SubscriptionManagementRequestCallElementsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SubscriptionManagementRequestCallElementsType", propOrder = {
    "clientAddress",
    "serverAddress",
    "serverFeatureType"
})
@XmlSeeAlso({
    org.openmuc.jeebus.spine.xsd.v1.NodeManagementSubscriptionRequestCallElementsType.SubscriptionRequest.class
})
public class SubscriptionManagementRequestCallElementsType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public SubscriptionManagementRequestCallElementsType() {
        super();
    }
     ...
     * 
     */
    public SubscriptionManagementRequestCallElementsType(final FeatureAddressElementsType clientAddress, final FeatureAddressElementsType serverAddress, final ElementTagType serverFeatureType) {
     ...
     *     The class instance
     */
    public SubscriptionManagementRequestCallElementsType withClientAddress(FeatureAddressElementsType value) {
     ...
     *     The class instance
     */
    public SubscriptionManagementRequestCallElementsType withServerAddress(FeatureAddressElementsType value) {
     ...
     *     The class instance
     */
    public SubscriptionManagementRequestCallElementsType withServerFeatureType(ElementTagType value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SubscriptionManagementRequestCallElementsType) {
            final SubscriptionManagementRequestCallElementsType copy = ((SubscriptionManagementRequestCallElementsType) draftCopy);
            {
    ...
    public boolean equals(Object object) {
        ...
        final SubscriptionManagementRequestCallElementsType that = ((SubscriptionManagementRequestCallElementsType) object);
        {
