...
/**
 * <p>Java class for TierDescriptionDataElementsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TierDescriptionDataElementsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "TierDescriptionDataElementsType", propOrder = {
    "tierId",
    "tierType",
    "label",
    "description"
...
@XmlSeeAlso({
    org.openmuc.jeebus.spine.xsd.v1.IncentiveTableDescriptionTierElementsType.TierDescription.class
})
public class TierDescriptionDataElementsType implements Cloneable, CopyTo, ToString
{

    protected ElementTagType tierId;
    protected ElementTagType tierType;
     ...
     * 
     */
    public TierDescriptionDataElementsType() {
        super();
    }
     ...
     * 
     */
    public TierDescriptionDataElementsType(final ElementTagType tierId, final ElementTagType tierType, final ElementTagType label, final ElementTagType description) {
        this.tierId = tierId;
     ...
     *     
     */
    public ElementTagType getTierType() {
        return tierType;
    }
     ...
     *     
     */
    public void setTierType(ElementTagType value) {
        this.tierType = value;
    }
     ...
     *     The class instance
     */
    public TierDescriptionDataElementsType withTierId(ElementTagType value) {
        setTierId(value);
        return this;
    }
     ...
     *     The class instance
     */
    public TierDescriptionDataElementsType withTierType(ElementTagType value) {
        setTierType(value);
        return this;
    }
     ...
     *     The class instance
     */
    public TierDescriptionDataElementsType withLabel(ElementTagType value) {
        setLabel(value);
        return this;
    }
     ...
     *     The class instance
     */
    public TierDescriptionDataElementsType withDescription(ElementTagType value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TierDescriptionDataElementsType) {
            final TierDescriptionDataElementsType copy = ((TierDescriptionDataElementsType) draftCopy);
            {
            ...
            }
            {
                ...
                if (tierTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    ElementTagType sourceTierType;
                    sourceTierType = this.getTierType();
                    ElementTagType copyTierType = ((ElementTagType) strategy.copy(LocatorUtils.property(locator, "tierType", sourceTierType), sourceTierType, (this.tierType!= null)));
    ...
    public boolean equals(Object object) {
        ...
        final TierDescriptionDataElementsType that = ((TierDescriptionDataElementsType) object);
        {
        ...
        {
            ElementTagType leftTierType;
            leftTierType = this.getTierType();
            ElementTagType rightTierType;
