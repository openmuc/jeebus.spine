...
/**
 * <p>Java class for PowerSequenceDescriptionListDataSelectorsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PowerSequenceDescriptionListDataSelectorsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PowerSequenceDescriptionListDataSelectorsType", propOrder = {
    "sequenceId"
})
@XmlSeeAlso({
    org.openmuc.jeebus.spine.xsd.v1.SmartEnergyManagementPsDataSelectorsType.PowerSequenceDescription.class
})
public class PowerSequenceDescriptionListDataSelectorsType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public PowerSequenceDescriptionListDataSelectorsType() {
        super();
    }
     ...
     * 
     */
    public PowerSequenceDescriptionListDataSelectorsType(final Long sequenceId) {
     ...
     *     The class instance
     */
    public PowerSequenceDescriptionListDataSelectorsType withSequenceId(Long value) {
        setSequenceId(value);
        return this;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PowerSequenceDescriptionListDataSelectorsType) {
            final PowerSequenceDescriptionListDataSelectorsType copy = ((PowerSequenceDescriptionListDataSelectorsType) draftCopy);
            {
    ...
    public boolean equals(Object object) {
        ...
        final PowerSequenceDescriptionListDataSelectorsType that = ((PowerSequenceDescriptionListDataSelectorsType) object);
        {
            Long leftSequenceId;
