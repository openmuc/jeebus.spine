...
/**
 * <p>Java class for SubscriptionManagementEntryDataElementsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SubscriptionManagementEntryDataElementsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SubscriptionManagementEntryDataElementsType", propOrder = {
    "subscriptionId",
    "clientAddress",
    "serverAddress",
    "label",
...
@XmlSeeAlso({
    org.openmuc.jeebus.spine.xsd.v1.NodeManagementSubscriptionDataElementsType.SubscriptionEntry.class
})
public class SubscriptionManagementEntryDataElementsType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public SubscriptionManagementEntryDataElementsType() {
        super();
    }
     ...
     * 
     */
    public SubscriptionManagementEntryDataElementsType(final ElementTagType subscriptionId, final FeatureAddressElementsType clientAddress, final FeatureAddressElementsType serverAddress, final ElementTagType label, final ElementTagType description) {
     ...
     *     The class instance
     */
    public SubscriptionManagementEntryDataElementsType withSubscriptionId(ElementTagType value) {
     ...
     *     The class instance
     */
    public SubscriptionManagementEntryDataElementsType withClientAddress(FeatureAddressElementsType value) {
     ...
     *     The class instance
     */
    public SubscriptionManagementEntryDataElementsType withServerAddress(FeatureAddressElementsType value) {
     ...
     *     The class instance
     */
    public SubscriptionManagementEntryDataElementsType withLabel(ElementTagType value) {
        setLabel(value);
        return this;
    }
     ...
     *     The class instance
     */
    public SubscriptionManagementEntryDataElementsType withDescription(ElementTagType value) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SubscriptionManagementEntryDataElementsType) {
            final SubscriptionManagementEntryDataElementsType copy = ((SubscriptionManagementEntryDataElementsType) draftCopy);
            {
    ...
    public boolean equals(Object object) {
        ...
        final SubscriptionManagementEntryDataElementsType that = ((SubscriptionManagementEntryDataElementsType) object);
        {
