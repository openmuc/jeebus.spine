...
/**
 * <p>Java class for PowerSequenceScheduleConfigurationRequestCallElementsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PowerSequenceScheduleConfigurationRequestCallElementsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PowerSequenceScheduleConfigurationRequestCallElementsType", propOrder = {
    "sequenceId"
})
@XmlSeeAlso({
    org.openmuc.jeebus.spine.xsd.v1.SmartEnergyManagementPsConfigurationRequestCallElementsType.ScheduleConfigurationRequest.class
})
public class PowerSequenceScheduleConfigurationRequestCallElementsType implements Cloneable, CopyTo, ToString
{
     ...
     * 
     */
    public PowerSequenceScheduleConfigurationRequestCallElementsType() {
        super();
    }
     ...
     * 
     */
    public PowerSequenceScheduleConfigurationRequestCallElementsType(final ElementTagType sequenceId) {
     ...
     *     The class instance
     */
    public PowerSequenceScheduleConfigurationRequestCallElementsType withSequenceId(ElementTagType value) {
        setSequenceId(value);
        return this;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PowerSequenceScheduleConfigurationRequestCallElementsType) {
            final PowerSequenceScheduleConfigurationRequestCallElementsType copy = ((PowerSequenceScheduleConfigurationRequestCallElementsType) draftCopy);
            {
    ...
    public boolean equals(Object object) {
        ...
        final PowerSequenceScheduleConfigurationRequestCallElementsType that = ((PowerSequenceScheduleConfigurationRequestCallElementsType) object);
        {
